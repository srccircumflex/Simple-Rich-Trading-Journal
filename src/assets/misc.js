        ...
        setTimeout(
            function () {
                ...
                dragul.on("drop", function (el, target, source, sibling) {
                    ...
                    __setter.call(drag_event_receiver, JSON.stringify(result));
                    var client_event = new Event('input', { bubbles: true });
                    drag_event_receiver.dispatchEvent(client_event);
                });
            },
            1
        )
                ...
                function paste (e) {
                    ...
                    setTimeout(
                        function () {
                            ...
                            var client_event = new Event('input', { bubbles: true });
                            __setter.call(edit_event_receiver, JSON.stringify(update));
                            edit_event_receiver.dispatchEvent(client_event);
                        },
                        3
                    )
                };
