...
from src.config import color_theme, rc, styles
        ...
        noteEditorFileRequest := html.Div(
            [
                ...
                noteeditor_file_request_ig := html.Button(
                    "keep clone",
                    style={
                        "backgroundColor": color_theme.noteeditor_dialog_ignore,
                        "border": "1px solid",
                        "margin": "1px",
                        "width": "100%"
                    },
                ...
                noteeditor_file_request_rn := html.Button(
                    ...
                    style={
                        "backgroundColor": color_theme.noteeditor_dialog_rename,
                        "border": "1px solid",
                        "margin": "1px",
                        "width": "100%"
                    },
                ...
                noteeditor_file_request_ow := html.Button(
                    "overwrite clone",
                    style={
                        "backgroundColor": color_theme.noteeditor_dialog_overwrite,
                        "border": "1px solid",
                        "margin": "1px",
                        "width": "100%"
                    },
                ...
                html.Div(
                    [
                        ...
                        html.Span("Hold "),
                        html.Span("ctrl", style={"width": "50%", "fontWeight": "bold", "border": "1px solid", "backgroundColor": color_theme.noteeditor_dialog_ignore}),
                        html.Span(" (keep), "),
                        html.Span("shift", style={"width": "50%", "fontWeight": "bold", "border": "1px solid", "backgroundColor": color_theme.noteeditor_dialog_rename}),
                        html.Span(" (create) or "),
                        html.Span("ctrl+shift", style={"width": "50%", "fontWeight": "bold", "border": "1px solid", "backgroundColor": color_theme.noteeditor_dialog_overwrite}),
                        html.Span(" (overwrite) "),
                        html.Br(),
            ...
            style={
                ...
                "padding": "10px",
                "margin": "10px",
                "color": color_theme.noteeditor_dialog_fg,
                "backgroundColor": color_theme.noteeditor_dialog_bg,
                "border": "1px solid " + color_theme.noteeditor_dialog_border,
                "fontSize": "13px"
            },
