        ...
        if self.new_vis:
            ...
            if self.lc.calc_trades:
                ...
                self.figure.add_shape(
                    ...
                    y1=1,
                    line=dict(
                        color=styles.color_theme.shape_last_calc,
                        width=1,
                        dash="dot"
                    ),
                )
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    x=self.dates,
                    line=dict(color=styles.color_theme.trace_current_performance),
                    marker=dict(color=styles.color_theme.trace_current_performance),
                    showlegend=False
                ),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    x=self.dates,
                    line=dict(color=styles.color_theme.trace_dripping_performance),
                    marker=dict(color=styles.color_theme.trace_dripping_performance),
                    showlegend=False
                ),
                row=self.order[0], col=1, secondary_y=True
            )
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    y=self.deposits,
                    x=self.dates,
                    line=dict(color=styles.color_theme.trace_money),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    x=self.dates,
                    line=dict(color=styles.color_theme.trace_trade_sum_invest),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    y=self.trade_takes,
                    x=self.dates,
                    line=dict(color=styles.color_theme.trace_trade_sum_take),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    x=self.dates,
                    line=dict(color=styles.color_theme.trace_trade_performance),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    x=self.dates,
                    line=dict(color=styles.color_theme.trace_profit_per_day_avg),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    x=self.dates,
                    line=dict(color=styles.color_theme.trace_performance_per_day_avg),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    x=self.dates_2,
                    line=dict(color=styles.color_theme.trace_trade_sum_invest_trailing),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    x=self.dates_2,
                    line=dict(color=styles.color_theme.trace_trade_sum_take_trailing),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    x=self.dates_2,
                    line=dict(color=styles.color_theme.trace_trade_performance_trailing),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    x=self.dates_2,
                    line=dict(color=styles.color_theme.trace_profit_per_day_avg_trailing),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    x=self.dates_2,
                    line=dict(color=styles.color_theme.trace_performance_per_day_avg_trailing),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    y=self.activity_2,
                    x=self.dates_2,
                    line=dict(color=styles.color_theme.trace_activity),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    x=self.dates_2,
                    line=dict(color=styles.color_theme.trace_holdtime_avg),
