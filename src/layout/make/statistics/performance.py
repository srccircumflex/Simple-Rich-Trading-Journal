...
class _Performance:
    ...
    def __init__(
        ...
        self.opt__trailing(step_time, trailing_frame, trailing_interval, range_)
        ...
        if self.lc.first_record:
            ...
            if self.new_calc:
                ...
                while (last := last + self.step_time) <= self.lc.last_record.index_date:
                    ...
                    self.performance_per_day_avg.append(frame.avg_performance_per_day)
                    self.profit_per_day_avg.append(frame.avg_profit_per_day)
                ...
                self.performance_per_day_avg.append(self.lc.avg_performance_per_day)
                self.profit_per_day_avg.append(self.lc.avg_profit_per_day)
                ...
                while first <= self.lc.last_record.index_date:
                    ...
                    self.performance_per_day_avg_2.append(frame.avg_performance_per_day)
                    self.profit_per_day_avg_2.append(frame.avg_profit_per_day)
                ...
                self.performance_per_day_avg_2 = array(self.performance_per_day_avg_2)
                self.profit_per_day_avg_2 = array(self.profit_per_day_avg_2)
        ...
        if self.new_vis:
            ...
            if self.lc.calc_trades:
                ...
                self.figure.add_shape(
                    ...
                    y1=1,
                    line=dict(
                        color=color_theme.shape_last_calc,
                        width=1,
                        dash="dot"
                    ),
                )
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    y=self.profits,
                    x=self.dates,
                    line=dict(color=color_theme.trace_profit),
                    marker=dict(color=color_theme.trace_profit),
                    showlegend=False
                ),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    x=self.dates,
                    line=dict(color=color_theme.trace_current_performance),
                    marker=dict(color=color_theme.trace_current_performance),
                    showlegend=False
                ),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    x=self.dates,
                    line=dict(color=color_theme.trace_dripping_performance),
                    marker=dict(color=color_theme.trace_dripping_performance),
                    showlegend=False
                ),
                row=self.order[0], col=1, secondary_y=True
            )
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    y=self.summary,
                    x=self.dates,
                    line=dict(color=color_theme.trace_summary),
                    marker=dict(color=color_theme.trace_summary),
                    showlegend=False
                ),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    y=self.summary_rate,
                    x=self.dates,
                    line=dict(color=color_theme.trace_summary_rate),
                    marker=dict(color=color_theme.trace_summary_rate),
                    showlegend=False
                ),
            ...
            self.figure.add_trace(
                go.Bar(
                    ...
                    marker=dict(color=color_theme.trace_deposit, line=dict(width=0)),
                    showlegend=False
                ),
            ...
            self.figure.add_trace(
                go.Bar(
                    ...
                    marker=dict(color=color_theme.trace_payout, line=dict(width=0)),
                    showlegend=False,
                ),
                row=self.order[2], col=1, secondary_y=False
            )
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    y=self.deposits,
                    x=self.dates,
                    line=dict(color=color_theme.trace_money),
                    marker=dict(color=color_theme.trace_money),
                    showlegend=False
                ),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    x=self.dates,
                    line=dict(color=color_theme.trace_trade_sum_invest),
                    marker=dict(color=color_theme.trace_trade_sum_invest),
                    showlegend=False
                ),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    y=self.trade_takes,
                    x=self.dates,
                    line=dict(color=color_theme.trace_trade_sum_take),
                    marker=dict(color=color_theme.trace_trade_sum_take),
                    showlegend=False
                ),
                row=self.order[3], col=1, secondary_y=False
            )
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    x=self.dates,
                    line=dict(color=color_theme.trace_trade_performance),
                    marker=dict(color=color_theme.trace_trade_performance),
                    showlegend=False
                ),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    x=self.dates,
                    line=dict(color=color_theme.trace_profit_per_day_avg),
                    marker=dict(color=color_theme.trace_profit_per_day_avg),
                    showlegend=False
                ),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    x=self.dates,
                    line=dict(color=color_theme.trace_performance_per_day_avg),
                    marker=dict(color=color_theme.trace_performance_per_day_avg),
                    showlegend=False
                ),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    x=self.dates_2,
                    line=dict(color=color_theme.trace_trade_sum_invest_trailing),
                    marker=dict(color=color_theme.trace_trade_sum_invest_trailing),
                    showlegend=False
                ),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    x=self.dates_2,
                    line=dict(color=color_theme.trace_trade_sum_take_trailing),
                    marker=dict(color=color_theme.trace_trade_sum_take_trailing),
                    showlegend=False
                ),
                row=self.order[5], col=1, secondary_y=False
            )
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    x=self.dates_2,
                    line=dict(color=color_theme.trace_trade_performance_trailing),
                    marker=dict(color=color_theme.trace_trade_performance_trailing),
                    showlegend=False
                ),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    x=self.dates_2,
                    line=dict(color=color_theme.trace_profit_per_day_avg_trailing),
                    marker=dict(color=color_theme.trace_profit_per_day_avg_trailing),
                    showlegend=False
                ),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    x=self.dates_2,
                    line=dict(color=color_theme.trace_performance_per_day_avg_trailing),
                    marker=dict(color=color_theme.trace_performance_per_day_avg_trailing),
                    showlegend=False
                ),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    y=self.activity_2,
                    x=self.dates_2,
                    line=dict(color=color_theme.trace_activity),
                    marker=dict(color=color_theme.trace_activity),
                    showlegend=False,
                ),
            ...
            self.figure.add_trace(
                go.Scatter(
                    ...
                    x=self.dates_2,
                    line=dict(color=color_theme.trace_holdtime_avg),
                    marker=dict(color=color_theme.trace_holdtime_avg),
                    showlegend=False
                ),
