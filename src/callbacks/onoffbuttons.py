...
_make_callback(layout.statistics.group_by_button, layout.statistics.group_by_trigger, styles.misc.by_type_on, "Group\u2007by\u2007Type\u2007", styles.misc.by_type_off, ("Group\u2007by\u2007Symbol" if rc.statisticsIdBySymbol else "Group\u2007by\u2007Name\u2007"))
_make_callback(layout.header.update_interval_button, layout.header.update_interval_button_trigger, styles.misc.interval_on, no_update, styles.misc.interval_off, no_update)
